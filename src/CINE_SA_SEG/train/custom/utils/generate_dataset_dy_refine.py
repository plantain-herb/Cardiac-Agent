...
def parse_args():
    ...
    parser.add_argument('--src_path', type=str, default='/home/qutaiping/nas/ori_data/AZHC/dul/del/SA/test')
    parser.add_argument('--tgt_path', type=str,
                        default="/home/qutaiping/nas/processed_data/processed_SA_dy_stage2")
...
def singe_generate_data(inputs):
    ...
    dcm_path, mask_path, tgt_path, pid = inputs
    # ret_string = f'{pid}.npz'
    # print(f'{pid} successed')
    # return ret_string
    for file in [dcm_path, mask_path]:
    ...
    heart_range_crop = get_seg_max_box(mask > 0, padding=30)
...
if __name__ == "__main__":
    ...
    for seg_file in sorted(os.listdir(src_seg_dir)):
        ...
        seg_file = os.path.join(src_seg_dir, pid + ".nii.gz")
        info = [vol_dir, seg_file, tgt_dir, pid]
