...
def parse_args():
    ...
    parser.add_argument(
        "--src_dicom_dir", type=str, default="/home/taiping-qu/code/mr_heart_seg_thin/train/train_data/ori_data/LGE_class/train"
        )
    parser.add_argument(
        "--src_dicom_val_dir", type=str, default="/home/taiping-qu/code/mr_heart_seg_thin/train/train_data/ori_data/LGE_class/train"
        )
    parser.add_argument(
    ...
    parser.add_argument(
        "--tgt_dir", type=str, default="/home/taiping-qu/code/mr_heart_seg_thin/train/train_data/processed_data_LGE_class"
    )
    parser.add_argument(
        "--tgt_val_dir", type=str, default="/home/taiping-qu/code/mr_heart_seg_thin/train/train_data/processed_data_LGE_class/val"
    )
...
def gen_single_data(info):
    idx, pid, dcm_file, save_file, gt = info
    # try:
    dcm_array, _, spacing = load_scans(dcm_file)
...
if __name__ == "__main__":
    ...
    excel_file = os.path.join(src_labels_dir, "LGE_class.xlsx")
