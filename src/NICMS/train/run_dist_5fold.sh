...
for fold in 1 2 3 4 5; do
  ...
  CUDA_VISIBLE_DEVICES=2,3 torchrun --master_port 29504 --nproc_per_node=2 train_5fold.py --config config/cine_class_config_5fold.py --fold $fold --launcher pytorch
done