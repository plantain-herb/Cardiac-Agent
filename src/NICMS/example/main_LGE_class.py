...
def parse_args():
    ...
    parser.add_argument(
        "--input_dicom_path", default=str(DATA_ROOT / "NICMS" / "LGE"),type=str
    )
    parser.add_argument("--output_path", default=str(OUTPUT_ROOT / "NICMS" / "LGE"), type=str)
    parser.add_argument(
        "--model_path",
    ...
    parser.add_argument(
        "--model_cls_file", 
        default=str(WEIGHTS_ROOT / "diagnosis_second" / "LGE_class.pth"),
        type=str,
    )
    parser.add_argument(
        "--network_cls_file", 
