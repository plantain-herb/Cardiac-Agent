...
def parse_args():
    ...
    parser.add_argument('--src_path', type=str, default='/home/qutaiping/nas/ori_data/AZHC/dul/del/4ch/image/train/data')
    parser.add_argument('--tgt_path', type=str,
                        default="/home/qutaiping/nas/processed_data/processed_4CH_dy_stage2_L")
...
def singe_generate_data(inputs):
    ...
    color_table = {0:0, 1:1, 2:2, 3:2, 4:0, 5:0, 6:0, 7:3}
