...
save_file = "4CH_heart_dice.lst"
ours_path = '/home/qutaiping/nas/ori_data/AZHC/dul/del/4ch/image/test/pred2'
lb_path = '/home/qutaiping/nas/ori_data/AZHC/dul/del/4ch/image/test/seg'
for pid in os.listdir(lb_path):
    ...
    for k, v in color_table.items():
        lb[lb == k] = v
    dice = calculate_all_dice(ours, lb, 6)
