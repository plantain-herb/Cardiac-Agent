...
def parse_args():
    ...
    # parser.add_argument("--input_path", default="/SMMN-Share/data_share/test_data/cine_seg_4ch/img", type=str)
    # parser.add_argument("--output_path", default="/SMMN-Share/data_share/test_data/cine_seg_4ch/pre", type=str)
