...
class DYPyramid_Sample_Dataset(DefaultSampleDataset):
    ...
    def _sample_source_data(self, idx, source_data_info):
        ...
        vol, seg1, seg2, src_spacing, src_shape, bbox, points_tp = (
            _source_data["vol"],
            _source_data["seg1"],
            _source_data["seg2"],
        ...
        vol, seg1, seg2 = self._crop_data(vol, seg1, seg2, c_t, src_shape, src_spacing)
    ...
    def _crop_data(self, vol, seg1, seg2, c_t, src_shape, src_spacing):
        ...
        for level in range(self._data_pyramid_level):
            ...
            data_pyramid.append((vol_patch, seg_patch1, seg_patch2))
