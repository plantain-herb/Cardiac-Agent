...
save_file = "2CH_heart_dice.lst"
ours_path = '/home/qutaiping/nas/ori_data/AZHC/dul/del/2ch/image/test/pred'
lb_path = '/home/qutaiping/nas/ori_data/AZHC/dul/del/2ch/image/test/seg'
for pid in os.listdir(lb_path):
    ...
    dice = calculate_all_dice(ours, lb, 2)
