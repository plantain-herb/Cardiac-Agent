...
def parse_args():
    ...
    parser.add_argument('--src_path', type=str, default='/home/qutaiping/nas/ori_data/cine_seg_ft/2ch')
    #parser.add_argument('--ct_set', type=str, default='0513')
    parser.add_argument('--tgt_path', type=str,
                        default="/home/qutaiping/nas/processed_data/processed_2CH_dy_stage1")
...
if __name__ == '__main__':
    ...
    for seg_file in sorted(os.listdir(src_seg_dir)):
        if '_2ch_seg.nii.gz' not in seg_file:
            print(f'heart seg file loss:{seg_file}')
            continue
        
        pid = seg_file.replace("_2ch_seg.nii.gz", "")
        vol_dir = os.path.join(src_dcm_dir, pid + "_2ch_image.nii.gz")
