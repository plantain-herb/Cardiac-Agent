...
def parse_args():
    ...
    parser.add_argument("--lst_file", default=str(DATA_ROOT / "CDS" / "val_fold5.lst"), type=str)
    parser.add_argument("--patients_root", default=str(DATA_ROOT / "CDS" / "patients"), type=str)
    parser.add_argument("--output_path", default=str(OUTPUT_ROOT / "CDS"), type=str)
    parser.add_argument(
        "--model_path",
    ...
    parser.add_argument(
        "--model_cls_file", 
        default=str(WEIGHTS_ROOT / "diagnosis_first" / "CDS.pth"),
        type=str,
    )
    parser.add_argument(
        "--network_cls_file", 
    ...
    parser.add_argument(
        "--csv_path",
        default=str(DATA_ROOT / "CDS" / "labels.csv"),
        type=str,
