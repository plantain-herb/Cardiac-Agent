...
patch_size = [3, 160, 160]
patch_size_inner = [3, 144, 144]
model = dict(
    type="Seg_Network_Heart_multi",
    ...
    head=dict(type="Seg_Head_Heart2d_multi", in_channels=32, scale_factor=(2.0, 2.0),),
    pipeline=[
        dict(
            type="Aug3dMini",
            aug_parameters=dict(
...
data = dict(
    ...
    train=dict(
        ...
        dst_list_file='./data/processed_data/processed_data_LGE_SA_second_stage/train.lst',
        data_root="./data/processed_data/processed_data_LGE_SA_second_stage",
...
work_dir = "./checkpoints/second_LGE_seg_agent"
gpus = 4
...
resume_from = None
load_from = "./checkpoints/second_LGE_seg/latest.pth"
workflow = [("train", 1)]
